      ...
      <div class="col-12 d-flex">
        <nav class="main-header navbar navbar-expand navbar-white navbar-light border-bottom-0 col-12">
          <span class="text-dark d-inline h4 pt-2 mr-0">
            <a href="{{ route('productos.index') }}" title="">
              <small><i class="ion ion-soup-can-outline">&nbsp;</i></small>{{ __('PRODUCTOS') }}
            </a>
          </span>
          <form class="form-inline ml-0" action="{{ route('productos.create') }}">
          ...
          <form class="form-inline ml-3" action="{{ route('productos.index') }}">
