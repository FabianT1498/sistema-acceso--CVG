      ...
      <div class="col-12 d-flex">
        <nav class="main-header navbar navbar-expand navbar-white navbar-light border-bottom-0 col-12">
          <span class="text-dark d-inline h4 pt-2 mr-0">
            <a href="{{ route('visitantes.index') }}" title="">
          ...
          <form id="searchForm" class="form-inline ml-3" action="{{ route('visitantes.index') }}">
            <div class="input-group input-group-sm">
              ...
              <input id="search" name="search" autocomplete="off" class="form-control form-control-navbar" type="search" placeholder="{{ __('Buscar') }}" aria-label="Search" value="{{ $search }}">
