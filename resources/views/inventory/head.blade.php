      ...
      <div class="col-12 d-flex">
        <nav class="main-header navbar navbar-expand navbar-white navbar-light border-bottom-0 col-12">
          <span class="text-dark d-inline h4 pt-2 mr-0">
            <a href="{{ route('inventarios.index') }}" title="">
              <small><i class="ion ion-ios-color-filter-outline">&nbsp;</i></small>{{ __('INVENTARIOS') }}
            </a>
          </span>
          <form class="form-inline ml-0" action="{{ route('inventarios.create') }}">
          ...
          <form class="form-inline ml-3" action="{{ route('inventarios.index') }}">
