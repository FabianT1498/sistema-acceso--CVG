...
@section('migasdepan')
    ...
    &nbsp;&nbsp;<i class="icon ion-android-arrow-forward"></i>&nbsp;&nbsp;{{ __('CONFIRMACION DE COMPRA') }}
...
@section('content')
  ...
  @include('warehouse.invoice.head')
  <!-- /.content-header -->
      ...
      <div class="container-fluid">
        ...
        <div class="row justify-content-center">
          <div class="col-12 col-md-10">
            <div class="card card-primary">
              <!-- form start -->
              <form method='POST' action="{{ route('compras-confirmada', $invoice->id) }}"  role="form">
                @method('PUT')
                @csrf
                ...
                <tbody>
                  @foreach ($invoice_details->get() as $invoice_detail)
                    <tr>
                        ...
                        <td>{{ $invoice_detail->invoice_quantity }}</td>
                        <td><input id="recived_quantity" value="{{ $invoice_detail->invoice_quantity }}"name="recived_quantity[]" type="text" class="form-control"></td>
        ...
        <!-- /.card-body -->
                <div class="card-footer">
                  <button type="submit" class="btn btn-primary">{{ __('Confirmar Compra') }}</button>
                </div>
              </form>
            </div>
            <!-- /.card -->
