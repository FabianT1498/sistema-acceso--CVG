...
@section('migasdepan')
    ...
    &nbsp;&nbsp;<i class="icon ion-android-arrow-forward"></i>&nbsp;&nbsp;{{ __('RECEPCION DE PAQUETES') }}
              ...
              <table id="tbl_read" class="table table-bordered table-hover">
                ...
                <tbody>
                  @foreach ($registros->get() as $registro)
                    <tr>
                      <td>
                        <a href="{{ route('recepcion-confirmar', $registro->id) }}"
                      ...
                      <td>
                        ...
                        <form id="frm_registro_{{ $registro->id }}" action="{{ route('recepcion-confirmar', $registro->id) }}" class="d-none">
                            @method('PUT')
                            @csrf
