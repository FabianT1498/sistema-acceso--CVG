            ...
            <form method='POST' action="{{ route('reportes.store') }}"  role="form"  enctype="multipart/form-data">
              ...
              <div class="card">
                  ...
                  <div class="form-group row mb-md-4">
                    ...
                    <div class="form-check form-check-inline">
                      <input 
                        ...
                        name="auto_option" 
                        value="0" 
                        {{ is_null(old('auto_option')) || old('auto_option') === '0' ? "checked" : ''}}
                      >
                ...
                <div class="card-footer">
                  <button id="visitBtnSubmit" type="submit" class="btn btn-success">{{ __('Crear Registro') }}</button>
                </div>
              </div>
